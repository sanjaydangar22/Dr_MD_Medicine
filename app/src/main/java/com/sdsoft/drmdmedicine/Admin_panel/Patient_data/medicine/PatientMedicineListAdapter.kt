...
class PatientMedicineListAdapter(var context: Context, var itemClick: (PatientMedicineModelClass) -> Unit) :
    RecyclerView.Adapter<PatientMedicineListAdapter.MyViewHolder>() {
...
//            .placeholder(R.drawable.ic_image).into(holder.medicineImage)
    ...
    fun updateList(medicineList: ArrayList<PatientMedicineModelClass>) {
